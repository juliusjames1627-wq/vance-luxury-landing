...
const pillars = [
  ...
  { icon: KeyRound, title: "Discreet Off-Market", desc: "A private network of qualified buyers and sellers — for clients who value privacy as much as the result." },
];
    ...
    <section className="py-20 md:py-28 border-t border-border">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="max-w-2xl mb-14">
          <p className="text-[11px] tracking-[0.3em] text-primary uppercase mb-3">Why work with us</p>
          <h2 className="font-display text-4xl md:text-5xl font-light text-foreground">A different standard, end to end.</h2>
        </div>
