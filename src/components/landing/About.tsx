    ...
    <section id="about" className="py-20 md:py-28 border-t border-border">
      <div className="max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="order-1 lg:order-2">
          <p className="text-[11px] tracking-[0.3em] text-primary uppercase mb-4">06 — About Elena Vance</p>
          ...
          <p className="mt-6 text-foreground/70 leading-relaxed">
            Elena Vance leads a boutique team built around one promise: high-touch service for high-ticket homes.
            From Richland's riverfront to West Richland's vineyards, our clients work with a true principal —
            not a hand-off — from first call to final signature.
          </p>
          <div className="mt-10 grid grid-cols-2 gap-6">
            {stats.map((s) => (
              <div key={s.l} className="border-l-2 border-primary pl-4">
                <div className="font-display text-3xl md:text-4xl font-light text-primary">{s.v}</div>
