...
const stats = [
  ...
  { v: "99.4%", l: "List-to-Sale Price" },
  { v: "$250M+", l: "Lifetime Volume" },
];

export function About() {
  return (
    <section id="about" className="py-20 md:py-28 border-t border-border/50 bg-card/30">
      <div className="max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="relative order-2 lg:order-1">
          <div className="aspect-[4/5] max-w-md mx-auto overflow-hidden rounded-md border border-primary/30">
            <img src={elena} alt="Elena Vance" loading="lazy" width={800} height={1024} className="h-full w-full object-cover" />
          </div>
          <div className="absolute -bottom-4 -right-2 lg:right-12 bg-primary text-primary-foreground px-5 py-3 text-sm tracking-widest uppercase">
            Founder · Lead Broker
          </div>
        </div>
        <div className="order-1 lg:order-2">
          <p className="text-xs tracking-[0.3em] text-primary uppercase mb-4">About Elena Vance</p>
          ...
          <div className="mt-10 grid grid-cols-2 gap-6">
            {stats.map((s) => (
              <div key={s.l} className="border-l-2 border-primary pl-4">
                <div className="text-2xl md:text-3xl font-light text-primary">{s.v}</div>
