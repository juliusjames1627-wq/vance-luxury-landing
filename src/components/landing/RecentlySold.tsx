        ...
        <div className="grid md:grid-cols-3 gap-px bg-border border border-border rounded-sm overflow-hidden">
          {sales.map((s) => (
            <div key={s.name} className="bg-card p-7">
              ...
              <p className="text-xs uppercase tracking-wider text-foreground/55 mt-1">
                {s.city}, WA
              </p>
              <div className="mt-6 flex items-end justify-between gap-3">
                <div>
                  <p className="text-[10px] tracking-widest uppercase text-foreground/45">Listed</p>
                  <p className="text-base text-foreground/70 line-through decoration-foreground/30">
                    {s.listed}
                  </p>
                </div>
              ...
              <p className="mt-5 text-xs text-foreground/55">
                Closed in <span className="text-foreground font-medium">{s.days} days</span>
              </p>
            </div>
          ))}
        </div>
